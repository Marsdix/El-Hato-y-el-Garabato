const SECTIONS = [
  ...
  {
    num: '02',
    title: 'Productos y sistema de compra',
    content: (
      <>
        <p>
  ...
  {
    num: '03',
    title: 'Pago, entrega y desistimiento',
    content: (
      <>
        <p>
  ...
  return (
    <section className="legal-section">
      <p className="legal-intro">
        Las presentes condiciones generales de contratación regulan expresamente las relaciones entre
