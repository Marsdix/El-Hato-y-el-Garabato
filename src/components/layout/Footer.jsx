      ...
      <div className="footer-top">
        ...
        <div className="footer-col">
          ...
          <ul>
            ...
            <li>
              <a href="https://elhatoyelgarabato.com/blog/" target="_blank" rel="noopener noreferrer">
                {t('footer.col1.blog')}
              </a>
            </li>
          </ul>
        ...
        <div className="footer-col">
          ...
          <ul>
            ...
            <li>
              <a href="https://elhatoyelgarabato.com/producto/eclectico-blanco-con-crianza-en-barrica-de-roble-frances/" target="_blank" rel="noopener noreferrer">
                Ecléctico Barrica
              </a>
            </li>
            <li>
              <a href="https://elhatoyelgarabato.com/producto/de-buena-jera-2018/" target="_blank" rel="noopener noreferrer">
                De Buena Jera
              </a>
            </li>
          </ul>
